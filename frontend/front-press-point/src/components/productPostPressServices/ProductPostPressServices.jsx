...
export default function ProductPostPressServices()
{
    ...
    },
    {
        ...
        {
          format: 'Блокнот А4 формату',
          name: 'Перфорація сторінок',
          prices: [7.00, 8.00, 9.00, 10.00, 12.00, 14.00],
        },
        {
        ...
        },
        {
          format: 'Блокнот А5 формату',
          name: 'Перфорація сторінок',
          prices: [5.00, 6.00, 7.00, 8.00, 9.00, 10.00],
        },
        {
        ...
        },
        {
          format: 'Блокнот А6 формату',
          name: 'Перфорація сторінок',
          prices: [3.00, 4.00, 5.00, 6.00, 7.00, 8.00],
        },
        ]
    },
    {
        ...
        },
        {
          ...
          prices: [20.00, 24.00, 28.00, 35.00, 45.00],
        },
        {
          format: 'Євро формат',
          name: 'Матова ламінація',
        ...
        },
        {
          format: 'Євро формат',
          name: 'Скруглення кутів',
          prices: [21.00, 25.00, 30.00, 37.00, 47.00],
        },
        {
          format: 'Квадратний формат',
          name: 'Матова ламінація',
          prices: [31.00, 37.00, 43.00, 52.00, 65.00],
        },
        {
          format: 'Квадратний формат',
          name: 'Глянцева ламінація',
          prices: [29.00, 34.00, 40.00, 49.00, 60.00],
        },
        {
          format: 'Квадратний формат',
          name: 'Скруглення кутів',
          prices: [22.00, 26.00, 31.00, 39.00, 50.00],
        },
        ]
    },
    {
