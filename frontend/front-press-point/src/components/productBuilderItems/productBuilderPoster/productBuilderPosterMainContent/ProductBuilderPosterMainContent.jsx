import './ProductBuilderPosterMainContent.css'
...
export default function ProductBuilderPosterMainContent()
{
    ...
    return(
        <div className='product-builder-poster-main-content'>
            <div className='product-builder-poster-main-content-left-side-container'>
                <div className='product-builder-poster-main-content-left-side-container-left-box-buttons'>
                    <MainContentLeftSideButtons
                    statusButton={statusButton}
                    setStatusButton={setStatusButton}
                    />
                </div>
                <div className='product-builder-poster-main-content-left-side-container-right-box-contnt'>
                    {statusButton === "Загрузка" && (
                    <>
                        <div className='product-builder-poster-main-content-left-side-container-right-box-button-and-input-image-box'>
                            <div className='product-builder-poster-main-content-left-side-container-right-box-image-box'>
                                <img
                                src={productBuilderImage}
                                alt="productBuilderImage"
                                className='product-builder-poster-main-content-left-side-container-right-box-button-image'
                                />
                            </div>
                            <div className='product-builder-poster-main-content-left-side-container-right-box-button'>
                                <ProductBuilderImageUploadButton onImageUpload={handleImageUpload} />
                            </div>
                            </div>

                            <div className='product-builder-poster-main-content-left-side-container-right-box-input-image'>
                    ...
                    {statusButton === "Текст" && (
                        <>
                            <div className='product-builder-poster-main-content-left-side-container-right-box-text-button'>
            ...
            <div className='product-builder-poster-main-content-right-side-container'>
                <div className='product-builder-poster-main-content-right-side-text-customization-buttons'>
                    <>
                        {statusButton === 'Текст' && (
