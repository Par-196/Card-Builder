...
export default function PostcardPostProductionServicesTable({ rows }) {
  return (
    <TableContainer component={Paper}>
      ...
      >
        <TableHead>
          ...
          >
            <TableCell sx={{  width:'200px', fontSize: '24px'}}>Тираж</TableCell>
            <TableCell width='250' align="right" sx={{ fontSize: '14px' }}>
              501-1000
            </TableCell>
            <TableCell width='250' align="right" sx={{ fontSize: '14px' }}>
              101-500
