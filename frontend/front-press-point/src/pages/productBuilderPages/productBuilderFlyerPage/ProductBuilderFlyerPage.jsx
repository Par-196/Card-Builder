    ...
    const priceData = [
        {
            format: 'Стандарт',
            print: 'Одностр',
            prices: { '5001-10000': 4.20,'1001-5000': 6.20,'501-1000': 8.30,'201-500': 10.00,'100-200': 12.00  }
        },
        {
            format: 'Стандарт',
            print: 'Двостр',
            prices: {'5001-10000': 4.58,'1001-5000': 6.87,'501-1000': 9.30,'201-500': 12.00,'100-200': 13.00 }
        }
    ];
    ...
    const laminationData = [
        {
            format: 'Стандарт',
            lamination: 'Глянцева',
            prices: {'5001-10000': 1.30,'1001-5000': 1.70,'501-1000': 2.10,'201-500': 2.80,'100-200': 3.50
            }
        },
        {
            format: 'Стандарт',
            lamination: 'Матова',
            prices: {'5001-10000': 1.50,'1001-5000': 1.90,'501-1000': 2.30,'201-500': 3.00,'100-200': 3.80
            }
        }
    ];
